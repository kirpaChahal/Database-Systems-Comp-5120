...
public class shipperTbl extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					shipperTbl frame = new shipperTbl();
...
public shipperTbl() {
	...
	String orderquery = "SELECT * FROM db_shipper LIMIT 0,8";
	jt4 = new javax.swing.JTable(obj.my_db_select(orderquery,2),column);
	scrollPane.setViewportView(jt4);
	...
	JLabel lblNewLabel = new JLabel("Shipper");
