...
public class subjectTbl extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					subjectTbl frame = new subjectTbl();
...
public subjectTbl() {
	...
	String[] column= {"SubjectID","CategoryName"};
	String orderquery = "SELECT * FROM db_subject LIMIT 0,8";
	jt6 = new javax.swing.JTable(obj.my_db_select(orderquery,2),column);
	scrollPane.setViewportView(jt6);
