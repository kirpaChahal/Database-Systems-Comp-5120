...
public bookTbl() {
	...
	String[] column= {"BookID","Title","UnitPrice","Author","Quantity","SupplierID","SubjectID"};
	String orderquery = "SELECT * FROM db_book LIMIT 0,8";
	jt3 = new javax.swing.JTable(obj.my_db_select(orderquery,7),column);
	scrollPane.setViewportView(jt3);
