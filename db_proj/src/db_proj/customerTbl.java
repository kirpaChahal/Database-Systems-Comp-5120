...
public class customerTbl extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					customerTbl frame = new customerTbl();
...
public customerTbl() {
	...
	String[] column= {"CustomerID","LastName","FirstName","Phone"};
	String orderquery = "SELECT * FROM db_customer LIMIT 0,8";
	jt8 = new javax.swing.JTable(obj.my_db_select(orderquery,4),column);
	scrollPane.setViewportView(jt8);
