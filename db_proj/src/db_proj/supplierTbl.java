...
public class supplierTbl extends JFrame {

	private JPanel contentPane;
	private javax.swing.JTable jt9;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					supplierTbl frame = new supplierTbl();
...
public supplierTbl() {
	...
	String[] column= {"SupplierID","CompanyName","ContactLastName","ContactFirstName","Phone"};
	String orderquery = "SELECT * FROM db_supplier LIMIT 0,8";
	jt9 = new javax.swing.JTable(obj.my_db_select(orderquery,5),column);
	scrollPane.setViewportView(jt9);
	...
	//CUSTOMER
	JButton btnNewButton_4 = new JButton("Customer");
	...
	//EMPLOYEE
	JButton btnNewButton_5 = new JButton("Employee");
